    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quote_alignment', models.CharField(max_length=255, default='', choices=ALIGN_CHOICES, blank=True, verbose_name='Alignment')),
        ...
        migrations.CreateModel(
            name='Bootstrap4Code',
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(primary_key=True, to='cms.CMSPlugin', serialize=False, auto_created=True, related_name='bootstrap4_content_bootstrap4code', parent_link=True)),
