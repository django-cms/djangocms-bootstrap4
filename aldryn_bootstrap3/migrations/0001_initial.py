...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'aldryn_bootstrap3_boostrap3blockquoteplugin', (
            ...
            ('breakpoints', self.gf('django.db.models.fields.CharField')(default=u'', max_length=255, blank=True)),
            ('context', self.gf('django.db.models.fields.CharField')(default=u'', max_length=255, blank=True)),
        ))
        db.send_create_signal(u'aldryn_bootstrap3', ['Boostrap3BlockquotePlugin'])

        # Adding model 'Boostrap3ButtonPlugin'
        db.create_table(u'aldryn_bootstrap3_boostrap3buttonplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(related_name=u'+', unique=True, primary_key=True, to=orm['cms.CMSPlugin'])),
            ('breakpoints', self.gf('django.db.models.fields.CharField')(default=u'', max_length=255, blank=True)),
            ('context', self.gf('django.db.models.fields.CharField')(default=u'', max_length=255, blank=True)),
            ('label', self.gf('django.db.models.fields.CharField')(default=u'', max_length=255, blank=True)),
        ))
        db.send_create_signal(u'aldryn_bootstrap3', ['Boostrap3ButtonPlugin'])


    def backwards(self, orm):
        # Deleting model 'Boostrap3BlockquotePlugin'
        db.delete_table(u'aldryn_bootstrap3_boostrap3blockquoteplugin')

        # Deleting model 'Boostrap3ButtonPlugin'
        db.delete_table(u'aldryn_bootstrap3_boostrap3buttonplugin')
