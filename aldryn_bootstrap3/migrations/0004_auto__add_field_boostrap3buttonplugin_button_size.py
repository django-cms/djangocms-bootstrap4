...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Boostrap3ButtonPlugin.button_size'
        db.add_column(u'aldryn_bootstrap3_boostrap3buttonplugin', 'button_size',
                      self.gf(u'django.db.models.fields.CharField')(default=u'', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Boostrap3ButtonPlugin.button_size'
        db.delete_column(u'aldryn_bootstrap3_boostrap3buttonplugin', 'button_size')
    ...
    models = {
        ...
        u'aldryn_bootstrap3.boostrap3buttonplugin': {
            ...
            'button_size': (u'django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '255', 'blank': 'True'}),
