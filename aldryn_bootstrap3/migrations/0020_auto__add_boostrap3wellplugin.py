...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Boostrap3WellPlugin'
        db.create_table(u'aldryn_bootstrap3_boostrap3wellplugin', (
        ...
        db.send_create_signal(u'aldryn_bootstrap3', ['Boostrap3WellPlugin'])


    def backwards(self, orm):
        # Deleting model 'Boostrap3WellPlugin'
        db.delete_table(u'aldryn_bootstrap3_boostrap3wellplugin')
