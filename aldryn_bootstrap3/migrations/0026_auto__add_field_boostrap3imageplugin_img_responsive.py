...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Boostrap3ImagePlugin.img_responsive'
        db.add_column(u'aldryn_bootstrap3_boostrap3imageplugin', 'img_responsive',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Boostrap3ImagePlugin.img_responsive'
        db.delete_column(u'aldryn_bootstrap3_boostrap3imageplugin', 'img_responsive')
