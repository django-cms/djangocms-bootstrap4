...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bootstrap3CarouselPlugin.aspect_ratio'
        db.add_column(u'aldryn_bootstrap3_bootstrap3carouselplugin', 'aspect_ratio',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=10, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bootstrap3CarouselPlugin.aspect_ratio'
        db.delete_column(u'aldryn_bootstrap3_bootstrap3carouselplugin', 'aspect_ratio')
