...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Boostrap3PanelBodyPlugin'
        db.create_table(u'aldryn_bootstrap3_boostrap3panelbodyplugin', (
        ...
        db.send_create_signal(u'aldryn_bootstrap3', ['Boostrap3PanelBodyPlugin'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Boostrap3PanelBodyPlugin'
        db.delete_table(u'aldryn_bootstrap3_boostrap3panelbodyplugin')
