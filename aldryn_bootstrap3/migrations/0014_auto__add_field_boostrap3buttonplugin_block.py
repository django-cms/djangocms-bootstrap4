...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Boostrap3ButtonPlugin.block'
        db.add_column(u'aldryn_bootstrap3_boostrap3buttonplugin', 'block',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Boostrap3ButtonPlugin.block'
        db.delete_column(u'aldryn_bootstrap3_boostrap3buttonplugin', 'block')
