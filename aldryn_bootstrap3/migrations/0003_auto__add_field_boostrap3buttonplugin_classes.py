...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Boostrap3ButtonPlugin.classes'
        db.add_column(u'aldryn_bootstrap3_boostrap3buttonplugin', 'classes',
                      self.gf(u'django.db.models.fields.TextField')(default=u'', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Boostrap3ButtonPlugin.classes'
        db.delete_column(u'aldryn_bootstrap3_boostrap3buttonplugin', 'classes')
