...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bootstrap3ColumnPlugin.tag'
        db.add_column(u'aldryn_bootstrap3_bootstrap3columnplugin', 'tag',
                      self.gf('django.db.models.fields.SlugField')(default=u'div', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bootstrap3ColumnPlugin.tag'
        db.delete_column(u'aldryn_bootstrap3_bootstrap3columnplugin', 'tag')
