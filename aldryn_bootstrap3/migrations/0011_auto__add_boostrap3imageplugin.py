...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'aldryn_bootstrap3_boostrap3imageplugin', (
            ...
            ('file', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'+', null=True, on_delete=models.SET_NULL, to=orm['filer.Image'])),
            ('alt', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('title', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('aspect_ratio', self.gf('django.db.models.fields.CharField')(default=u'', max_length=10, blank=True)),
            ('thumbnail', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('shape', self.gf('django.db.models.fields.CharField')(default=u'', max_length=64, blank=True)),
            ('classes', self.gf(u'django.db.models.fields.TextField')(default=u'', blank=True)),
        ))
        db.send_create_signal(u'aldryn_bootstrap3', ['Boostrap3ImagePlugin'])


    def backwards(self, orm):
        # Deleting model 'Boostrap3ImagePlugin'
        db.delete_table(u'aldryn_bootstrap3_boostrap3imageplugin')
