...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Boostrap3AlertPlugin'
        db.create_table(u'aldryn_bootstrap3_boostrap3alertplugin', (
        ...
        db.send_create_signal(u'aldryn_bootstrap3', ['Boostrap3AlertPlugin'])


    def backwards(self, orm):
        # Deleting model 'Boostrap3AlertPlugin'
        db.delete_table(u'aldryn_bootstrap3_boostrap3alertplugin')
