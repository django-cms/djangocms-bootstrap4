...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Bootstrap3AccordionPlugin'
        db.create_table(u'aldryn_bootstrap3_bootstrap3accordionplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('classes', self.gf(u'django.db.models.fields.TextField')(default=u'', blank=True)),
        ))
        db.send_create_signal(u'aldryn_bootstrap3', ['Bootstrap3AccordionPlugin'])

        # Adding model 'Bootstrap3AccordionItemPlugin'
        db.create_table(u'aldryn_bootstrap3_bootstrap3accordionitemplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
        ...
        db.send_create_signal(u'aldryn_bootstrap3', ['Bootstrap3AccordionItemPlugin'])


    def backwards(self, orm):
        # Deleting model 'Bootstrap3AccordionPlugin'
        db.delete_table(u'aldryn_bootstrap3_bootstrap3accordionplugin')

        # Deleting model 'Bootstrap3AccordionItemPlugin'
        db.delete_table(u'aldryn_bootstrap3_bootstrap3accordionitemplugin')
