...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Boostrap3PanelFooterPlugin'
        db.create_table(u'aldryn_bootstrap3_boostrap3panelfooterplugin', (
        ...
        db.send_create_signal(u'aldryn_bootstrap3', ['Boostrap3PanelFooterPlugin'])

        # Adding model 'Boostrap3PanelHeadingPlugin'
        db.create_table(u'aldryn_bootstrap3_boostrap3panelheadingplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(related_name=u'+', unique=True, primary_key=True, to=orm['cms.CMSPlugin'])),
            ('title', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('classes', self.gf(u'django.db.models.fields.TextField')(default=u'', blank=True)),
        ))
        db.send_create_signal(u'aldryn_bootstrap3', ['Boostrap3PanelHeadingPlugin'])

        # Adding model 'Boostrap3PanelPlugin'
        db.create_table(u'aldryn_bootstrap3_boostrap3panelplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(related_name=u'+', unique=True, primary_key=True, to=orm['cms.CMSPlugin'])),
            ('context', self.gf(u'django.db.models.fields.CharField')(default=u'default', max_length=255)),
            ('classes', self.gf(u'django.db.models.fields.TextField')(default=u'', blank=True)),
        ))
        db.send_create_signal(u'aldryn_bootstrap3', ['Boostrap3PanelPlugin'])

        # Adding model 'Boostrap3PabelBodyPlugin'
        db.create_table(u'aldryn_bootstrap3_boostrap3pabelbodyplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(related_name=u'+', unique=True, primary_key=True, to=orm['cms.CMSPlugin'])),
            ('classes', self.gf(u'django.db.models.fields.TextField')(default=u'', blank=True)),
        ))
        db.send_create_signal(u'aldryn_bootstrap3', ['Boostrap3PabelBodyPlugin'])


    def backwards(self, orm):
        # Deleting model 'Boostrap3PanelFooterPlugin'
        db.delete_table(u'aldryn_bootstrap3_boostrap3panelfooterplugin')

        # Deleting model 'Boostrap3PanelHeadingPlugin'
        db.delete_table(u'aldryn_bootstrap3_boostrap3panelheadingplugin')

        # Deleting model 'Boostrap3PanelPlugin'
        db.delete_table(u'aldryn_bootstrap3_boostrap3panelplugin')

        # Deleting model 'Boostrap3PabelBodyPlugin'
        db.delete_table(u'aldryn_bootstrap3_boostrap3pabelbodyplugin')
    ...
    models = {
        ...
        u'aldryn_bootstrap3.boostrap3pabelbodyplugin': {
            'Meta': {'object_name': 'Boostrap3PabelBodyPlugin', '_ormbases': ['cms.CMSPlugin']},
            'classes': (u'django.db.models.fields.TextField', [], {'default': "u''", 'blank': 'True'}),
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "u'+'", 'unique': 'True', 'primary_key': 'True', 'to': "orm['cms.CMSPlugin']"})
        },
