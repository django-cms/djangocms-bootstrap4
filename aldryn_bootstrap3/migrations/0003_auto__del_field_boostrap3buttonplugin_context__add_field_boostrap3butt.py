...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Boostrap3ButtonPlugin.context'
        db.delete_column(u'aldryn_bootstrap3_boostrap3buttonplugin', 'context')

        # Adding field 'Boostrap3ButtonPlugin.button_type'
        db.add_column(u'aldryn_bootstrap3_boostrap3buttonplugin', 'button_type',
                      self.gf(u'django.db.models.fields.CharField')(default=u'btn-default', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Boostrap3ButtonPlugin.context'
        db.add_column(u'aldryn_bootstrap3_boostrap3buttonplugin', 'context',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'Boostrap3ButtonPlugin.button_type'
        db.delete_column(u'aldryn_bootstrap3_boostrap3buttonplugin', 'button_type')
    ...
    models = {
        ...
        u'aldryn_bootstrap3.boostrap3buttonplugin': {
            ...
            'breakpoints': (u'django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'button_type': (u'django.db.models.fields.CharField', [], {'default': "u'btn-default'", 'max_length': '255'}),
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "u'+'", 'unique': 'True', 'primary_key': 'True', 'to': "orm['cms.CMSPlugin']"}),
