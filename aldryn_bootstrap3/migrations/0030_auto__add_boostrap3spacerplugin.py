...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Boostrap3SpacerPlugin'
        db.create_table(u'aldryn_bootstrap3_boostrap3spacerplugin', (
            ...
            ('size', self.gf(u'django.db.models.fields.CharField')(default=u'md', max_length=255, blank=True)),
            ('classes', self.gf(u'django.db.models.fields.TextField')(default=u'', blank=True)),
        ))
        db.send_create_signal(u'aldryn_bootstrap3', ['Boostrap3SpacerPlugin'])


    def backwards(self, orm):
        # Deleting model 'Boostrap3SpacerPlugin'
        db.delete_table(u'aldryn_bootstrap3_boostrap3spacerplugin')
