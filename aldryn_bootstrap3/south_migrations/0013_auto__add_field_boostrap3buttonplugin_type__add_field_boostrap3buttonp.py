...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Boostrap3ButtonPlugin.type'
        db.add_column(u'aldryn_bootstrap3_boostrap3buttonplugin', 'type',
                      self.gf('django.db.models.fields.CharField')(default=u'link', max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'Boostrap3ButtonPlugin.txt_context'
        db.add_column(u'aldryn_bootstrap3_boostrap3buttonplugin', 'txt_context',
                      self.gf(u'django.db.models.fields.CharField')(default=u'', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Boostrap3ButtonPlugin.type'
        db.delete_column(u'aldryn_bootstrap3_boostrap3buttonplugin', 'type')

        # Deleting field 'Boostrap3ButtonPlugin.txt_context'
        db.delete_column(u'aldryn_bootstrap3_boostrap3buttonplugin', 'txt_context')
    ...
    models = {
        ...
        u'aldryn_bootstrap3.boostrap3buttonplugin': {
            ...
            'txt_context': (u'django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '255'}),
            'type': ('django.db.models.fields.CharField', [], {'default': "u'link'", 'max_length': '10', 'blank': 'True'}),
