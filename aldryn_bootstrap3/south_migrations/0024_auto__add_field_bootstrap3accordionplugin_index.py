...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bootstrap3AccordionPlugin.index'
        db.add_column(u'aldryn_bootstrap3_bootstrap3accordionplugin', 'index',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bootstrap3AccordionPlugin.index'
        db.delete_column(u'aldryn_bootstrap3_bootstrap3accordionplugin', 'index')
