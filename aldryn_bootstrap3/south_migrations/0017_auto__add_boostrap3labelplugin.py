...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Boostrap3LabelPlugin'
        db.create_table(u'aldryn_bootstrap3_boostrap3labelplugin', (
        ...
        db.send_create_signal(u'aldryn_bootstrap3', ['Boostrap3LabelPlugin'])


    def backwards(self, orm):
        # Deleting model 'Boostrap3LabelPlugin'
        db.delete_table(u'aldryn_bootstrap3_boostrap3labelplugin')
