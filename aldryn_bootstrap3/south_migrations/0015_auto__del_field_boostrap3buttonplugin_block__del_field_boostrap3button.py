...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'aldryn_bootstrap3_boostrap3buttonplugin', 'block', 'btn_block')
        db.rename_column(u'aldryn_bootstrap3_boostrap3buttonplugin', 'size', 'btn_size')

    def backwards(self, orm):
        db.rename_column(u'aldryn_bootstrap3_boostrap3buttonplugin', 'btn_block', 'block')
        db.rename_column(u'aldryn_bootstrap3_boostrap3buttonplugin', 'btn_size', 'size')
