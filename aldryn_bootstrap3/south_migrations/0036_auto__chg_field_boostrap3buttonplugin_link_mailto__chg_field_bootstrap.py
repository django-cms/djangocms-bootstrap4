...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Boostrap3ButtonPlugin.link_mailto'
        db.alter_column(u'aldryn_bootstrap3_boostrap3buttonplugin', 'link_mailto', self.gf('django.db.models.fields.EmailField')(max_length=254, null=True))

        # Changing field 'Bootstrap3CarouselSlidePlugin.link_mailto'
        db.alter_column(u'aldryn_bootstrap3_bootstrap3carouselslideplugin', 'link_mailto', self.gf('django.db.models.fields.EmailField')(max_length=254, null=True))

    def backwards(self, orm):

        # Changing field 'Boostrap3ButtonPlugin.link_mailto'
        db.alter_column(u'aldryn_bootstrap3_boostrap3buttonplugin', 'link_mailto', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))

        # Changing field 'Bootstrap3CarouselSlidePlugin.link_mailto'
        db.alter_column(u'aldryn_bootstrap3_bootstrap3carouselslideplugin', 'link_mailto', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))
