...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Boostrap3ButtonPlugin.responsive'
        db.add_column(u'aldryn_bootstrap3_boostrap3buttonplugin', 'responsive',
                      self.gf(u'django.db.models.fields.TextField')(default=u'', blank=True),
                      keep_default=False)

        # Adding field 'Boostrap3ButtonPlugin.responsive_print'
        db.add_column(u'aldryn_bootstrap3_boostrap3buttonplugin', 'responsive_print',
                      self.gf(u'django.db.models.fields.TextField')(default=u'', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Boostrap3ButtonPlugin.responsive'
        db.delete_column(u'aldryn_bootstrap3_boostrap3buttonplugin', 'responsive')

        # Deleting field 'Boostrap3ButtonPlugin.responsive_print'
        db.delete_column(u'aldryn_bootstrap3_boostrap3buttonplugin', 'responsive_print')
