...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Bootstrap3CarouselPlugin'
        db.create_table(u'aldryn_bootstrap3_bootstrap3carouselplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('style', self.gf('django.db.models.fields.CharField')(default=u'standard', max_length=50)),
            ('transition_effect', self.gf('django.db.models.fields.CharField')(default=u'', max_length=50, blank=True)),
            ('ride', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ...
            ('pause', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('classes', self.gf(u'django.db.models.fields.TextField')(default=u'', blank=True)),
        ))
        db.send_create_signal(u'aldryn_bootstrap3', ['Bootstrap3CarouselPlugin'])

        # Adding model 'Bootstrap3CarouselSlidePlugin'
        db.create_table(u'aldryn_bootstrap3_bootstrap3carouselslideplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('link_url', self.gf('django.db.models.fields.URLField')(default=u'', max_length=200, blank=True)),
            ('link_page', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Page'], null=True, on_delete=models.SET_NULL, blank=True)),
            ('link_file', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File'], null=True, on_delete=models.SET_NULL, blank=True)),
            ('link_anchor', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
            ('link_mailto', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
            ('link_phone', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True)),
            ('link_target', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'+', null=True, on_delete=models.SET_NULL, to=orm['filer.Image'])),
            ('link_text', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('content', self.gf('djangocms_text_ckeditor.fields.HTMLField')(default=u'', blank=True)),
            ('classes', self.gf(u'django.db.models.fields.TextField')(default=u'', blank=True)),
        ))
        db.send_create_signal(u'aldryn_bootstrap3', ['Bootstrap3CarouselSlidePlugin'])


    def backwards(self, orm):
        # Deleting model 'Bootstrap3CarouselPlugin'
        db.delete_table(u'aldryn_bootstrap3_bootstrap3carouselplugin')

        # Deleting model 'Bootstrap3CarouselSlidePlugin'
        db.delete_table(u'aldryn_bootstrap3_bootstrap3carouselslideplugin')
