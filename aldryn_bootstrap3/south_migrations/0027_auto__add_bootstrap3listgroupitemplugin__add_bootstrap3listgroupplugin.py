...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Bootstrap3ListGroupItemPlugin'
        db.create_table(u'aldryn_bootstrap3_bootstrap3listgroupitemplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('title', self.gf(u'django.db.models.fields.TextField')(default=u'', blank=True)),
        ...
        db.send_create_signal(u'aldryn_bootstrap3', ['Bootstrap3ListGroupItemPlugin'])

        # Adding model 'Bootstrap3ListGroupPlugin'
        db.create_table(u'aldryn_bootstrap3_bootstrap3listgroupplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('classes', self.gf(u'django.db.models.fields.TextField')(default=u'', blank=True)),
        ))
        db.send_create_signal(u'aldryn_bootstrap3', ['Bootstrap3ListGroupPlugin'])


    def backwards(self, orm):
        # Deleting model 'Bootstrap3ListGroupItemPlugin'
        db.delete_table(u'aldryn_bootstrap3_bootstrap3listgroupitemplugin')

        # Deleting model 'Bootstrap3ListGroupPlugin'
        db.delete_table(u'aldryn_bootstrap3_bootstrap3listgroupplugin')
