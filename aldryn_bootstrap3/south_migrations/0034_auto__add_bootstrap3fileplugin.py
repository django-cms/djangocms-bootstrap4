...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Bootstrap3FilePlugin'
        db.create_table(u'aldryn_bootstrap3_bootstrap3fileplugin', (
            ...
            ('file', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'+', null=True, on_delete=models.SET_NULL, to=orm['filer.File'])),
            ('name', self.gf(u'django.db.models.fields.TextField')(default=u'', blank=True)),
            ('open_new_window', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('show_file_size', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('icon_left', self.gf(u'django.db.models.fields.CharField')(default=u'', max_length=255, blank=True)),
            ('icon_right', self.gf(u'django.db.models.fields.CharField')(default=u'', max_length=255, blank=True)),
            ('classes', self.gf(u'django.db.models.fields.TextField')(default=u'', blank=True)),
        ))
        db.send_create_signal(u'aldryn_bootstrap3', ['Bootstrap3FilePlugin'])


    def backwards(self, orm):
        # Deleting model 'Bootstrap3FilePlugin'
        db.delete_table(u'aldryn_bootstrap3_bootstrap3fileplugin')
