...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'aldryn_bootstrap3_boostrap3buttonplugin', 'context', 'btn_context')

    def backwards(self, orm):
        db.rename_column(u'aldryn_bootstrap3_boostrap3buttonplugin', 'btn_context', 'context')
    ...
    models = {
        ...
        u'aldryn_bootstrap3.boostrap3buttonplugin': {
            ...
            'btn_context': (u'django.db.models.fields.CharField', [], {'default': "u'link'", 'max_length': '255'}),
            'classes': (u'django.db.models.fields.TextField', [], {'default': "u''", 'blank': 'True'}),
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "u'+'", 'unique': 'True', 'primary_key': 'True', 'to': "orm['cms.CMSPlugin']"}),
