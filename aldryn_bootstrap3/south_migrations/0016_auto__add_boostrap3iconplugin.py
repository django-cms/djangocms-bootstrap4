...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Boostrap3IconPlugin'
        db.create_table(u'aldryn_bootstrap3_boostrap3iconplugin', (
            ...
            ('icon', self.gf(u'django.db.models.fields.CharField')(default=u'', max_length=255)),
            ('classes', self.gf(u'django.db.models.fields.TextField')(default=u'', blank=True)),
        ))
        db.send_create_signal(u'aldryn_bootstrap3', ['Boostrap3IconPlugin'])


    def backwards(self, orm):
        # Deleting model 'Boostrap3IconPlugin'
        db.delete_table(u'aldryn_bootstrap3_boostrap3iconplugin')
