...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Bootstrap3CarouselSlideFolderPlugin'
        db.create_table(u'aldryn_bootstrap3_bootstrap3carouselslidefolderplugin', (
        ...
        db.send_create_signal(u'aldryn_bootstrap3', ['Bootstrap3CarouselSlideFolderPlugin'])


    def backwards(self, orm):
        # Deleting model 'Bootstrap3CarouselSlideFolderPlugin'
        db.delete_table(u'aldryn_bootstrap3_bootstrap3carouselslidefolderplugin')
