...
from .models import Bootstrap5ListGroup, Bootstrap5ListGroupItem
...
class Bootstrap5ListGroupPlugin(CMSPluginBase):
    ...
    allow_children = True
    child_classes = ['Bootstrap5ListGroupItemPlugin', 'Bootstrap5LinkPlugin']
...
class Bootstrap5ListGroupItemPlugin(CMSPluginBase):
    ...
    change_form_template = 'djangocms_bootstrap5/admin/list-group.html'
    allow_children = True
    parent_classes = ['Bootstrap5ListGroupPlugin']
...
plugin_pool.register_plugin(Bootstrap5ListGroupPlugin)
plugin_pool.register_plugin(Bootstrap5ListGroupItemPlugin)
