...
from djangocms_bootstrap5.constants import COLOR_STYLE_CHOICES, TAG_CHOICES
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Bootstrap5ListGroup',
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='bootstrap5_listgroup_bootstrap5listgroup', serialize=False, to='cms.CMSPlugin')),
        ...
        migrations.CreateModel(
            name='Bootstrap5ListGroupItem',
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='bootstrap5_listgroup_bootstrap5listgroupitem', serialize=False, to='cms.CMSPlugin')),
