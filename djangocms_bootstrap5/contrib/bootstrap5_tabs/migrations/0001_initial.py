...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Bootstrap5Tab',
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(parent_link=True, serialize=False, primary_key=True, to='cms.CMSPlugin', auto_created=True, related_name='bootstrap5_tabs_bootstrap5tab', on_delete=models.CASCADE)),
                ...
                ('tag_type', djangocms_bootstrap5.fields.TagTypeField(max_length=255, choices=TAG_CHOICES, verbose_name='Tag type', default=TAG_CHOICES[0][0], help_text='Select the HTML tag to be used.')),
                ('attributes', djangocms_bootstrap5.fields.AttributesField(blank=True, verbose_name='Attributes', default=dict)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            name='Bootstrap5TabItem',
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(parent_link=True, serialize=False, primary_key=True, to='cms.CMSPlugin', auto_created=True, related_name='bootstrap5_tabs_bootstrap5tabitem', on_delete=models.CASCADE)),
