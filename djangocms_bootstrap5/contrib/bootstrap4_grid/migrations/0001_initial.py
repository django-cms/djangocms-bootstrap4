...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Bootstrap5GridColumn',
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='bootstrap5_grid_bootstrap5gridcolumn', serialize=False, to='cms.CMSPlugin')),
                ...
                ('column_size', djangocms_bootstrap5.fields.IntegerRangeField(blank=True, help_text='Nummeric value from 1 - 12. Spreads the columns evenly when empty.', null=True, verbose_name='Column size')),
                ...
                ('xs_col', djangocms_bootstrap5.fields.IntegerRangeField(blank=True, null=True)),
                ('xs_order', djangocms_bootstrap5.fields.IntegerRangeField(blank=True, null=True)),
                ('xs_ml', models.BooleanField(default=False)),
                ('xs_mr', models.BooleanField(default=False)),
                ('sm_col', djangocms_bootstrap5.fields.IntegerRangeField(blank=True, null=True)),
                ('sm_order', djangocms_bootstrap5.fields.IntegerRangeField(blank=True, null=True)),
                ('sm_ml', models.BooleanField(default=False)),
                ('sm_mr', models.BooleanField(default=False)),
                ('md_col', djangocms_bootstrap5.fields.IntegerRangeField(blank=True, null=True)),
                ('md_order', djangocms_bootstrap5.fields.IntegerRangeField(blank=True, null=True)),
                ('md_ml', models.BooleanField(default=False)),
                ('md_mr', models.BooleanField(default=False)),
                ('lg_col', djangocms_bootstrap5.fields.IntegerRangeField(blank=True, null=True)),
                ('lg_order', djangocms_bootstrap5.fields.IntegerRangeField(blank=True, null=True)),
                ('lg_ml', models.BooleanField(default=False)),
                ('lg_mr', models.BooleanField(default=False)),
                ('xl_col', djangocms_bootstrap5.fields.IntegerRangeField(blank=True, null=True)),
                ('xl_order', djangocms_bootstrap5.fields.IntegerRangeField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            name='Bootstrap5GridContainer',
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='bootstrap5_grid_bootstrap5gridcontainer', serialize=False, to='cms.CMSPlugin')),
