...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Bootstrap5Card',
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='bootstrap5_card_bootstrap5card', serialize=False, to='cms.CMSPlugin')),
        ...
        migrations.CreateModel(
            name='Bootstrap5CardInner',
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='bootstrap5_card_bootstrap5cardinner', serialize=False, to='cms.CMSPlugin')),
