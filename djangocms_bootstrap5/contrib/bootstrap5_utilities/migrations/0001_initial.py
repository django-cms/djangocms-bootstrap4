...
from djangocms_bootstrap5.constants import DEVICE_CHOICES, TAG_CHOICES
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Bootstrap5Spacing',
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='bootstrap5_utilities_bootstrap5spacing', serialize=False, to='cms.CMSPlugin')),
